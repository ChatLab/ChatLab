...
import { memberService, type SessionRuntimeAdapter } from '@openchatlab/node-runtime'

export function registerMemberRoutes(server: FastifyInstance, adapter: SessionRuntimeAdapter): void {
